        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <div class="relative inline-block">
                    ...
                    />
                    <div class="absolute -bottom-2 -right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full font-medium">
                        Active
                    </div>
                </div>
                <div class="mt-4">
                    ...
                    <Badge color="indigo" class="mt-3 text-sm px-3 py-1">Verified Attender</Badge>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-gray-900">{profile.email ?? profile.frappe_profile ?? "—"}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-gray-900 capitalize">{profile.gender ?? "—"}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-gray-900">{profile.dob ? new Date(profile.dob).toLocaleDateString() : "—"}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex-1">
                            <div class="text-sm font-medium text-gray-500">E-KYC Status</div>
                            <div class="mt-1">
                                <Badge
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex-1">
                            <div class="text-sm font-medium text-gray-500">Companion</div>
                            <div class="mt-1">
                                <Badge
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg md:col-span-2">
                        <div class="flex-shrink-0 mr-3">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-gray-900 font-mono">{profile.aadhar ?? "—"}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg md:col-span-2">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-gray-900">{profile.creation ? new Date(profile.creation).toLocaleDateString('en-IN', { year: 'numeric', month: 'long', day: 'numeric' }) : "—"}</div>
                        </div>
                    </div>
                </div>
            </div>
